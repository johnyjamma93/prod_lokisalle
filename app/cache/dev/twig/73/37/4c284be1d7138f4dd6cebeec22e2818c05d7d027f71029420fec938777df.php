...
class __TwigTemplate_73374c284be1d7138f4dd6cebeec22e2818c05d7d027f71029420fec938777df extends Twig_Template
{
    ...
    {
        // line 3
        $context["__internal_0ec36a873362b343c92bb1e058ded0c32fd6166b6a7fc059018b08adc3628acc"] = $this->env->loadTemplate("SyliusResourceBundle:Macros:actions.html.twig");
...
";
    ...
    <h1><i class=\"glyphicon glyphicon-plus-sign\"></i> ";
        // line 16
        echo $this->env->getExtension('translator')->trans("sylius.taxon.create_header");
        echo "</h1>
</div>
...
<form action=\"";
        // line 21
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("sylius_backend_taxon_create", array("taxonomyId" => $this->getAttribute($this->getAttribute((isset($context["taxon"]) ? $context["taxon"] : $this->getContext($context, "taxon")), "taxonomy"), "id"))), "html", null, true);
    ...
    ";
        ...
        // line 23
        echo "    ";
        echo $context["__internal_0ec36a873362b343c92bb1e058ded0c32fd6166b6a7fc059018b08adc3628acc"]->getcreate();
        echo "
</form>
";
    }
    ...
    {
        return "SyliusWebBundle:Backend/Taxon:create.html.twig";
    }
