...
class Payment extends \Sylius\Bundle\PaymentsBundle\Model\Payment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'method', 'currency', 'amount', 'state', 'creditCard', 'logs', 'createdAt', 'updatedAt', 'details');
        }
     ...
     * {@inheritDoc}
     */
    public function hasLog(\Sylius\Bundle\PaymentsBundle\Model\PaymentLogInterface $log)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hasLog', array($log));

        return parent::hasLog($log);
    }

    /**
     * {@inheritDoc}
     */
    public function addLog(\Sylius\Bundle\PaymentsBundle\Model\PaymentLogInterface $log)
    {
     ...
     * {@inheritDoc}
     */
    public function removeLog(\Sylius\Bundle\PaymentsBundle\Model\PaymentLogInterface $log)
    {
