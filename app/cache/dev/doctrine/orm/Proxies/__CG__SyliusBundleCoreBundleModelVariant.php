...
class Variant extends \Sylius\Bundle\CoreBundle\Model\Variant implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'sku', 'price', 'onHand', 'availableOnDemand', 'images', 'weight', 'width', 'height', 'depth', 'id', 'master', 'presentation', 'product', 'options', 'availableOn', 'createdAt', 'updatedAt', 'deletedAt');
        }
